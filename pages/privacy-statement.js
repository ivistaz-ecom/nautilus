...
const privacy = ({ data }) => {
    ...
    return (
        <>
            <Head>
        <title>Privacy Statement - Ship Management Company, Vessel Management Services | Nautilus Shipping</title>
        ...
        <meta property="og:title" content="Privacy Statement - Ship Management Company, Vessel Management Services | Nautilus Shipping" />
        ...
        <meta property="og:site_name" content="Privacy Statement - Ship Management Company, Vessel Management Services | Nautilus Shipping" />
